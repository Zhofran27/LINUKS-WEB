    ...
    <div className="space-y-16 max-w-7xl mx-auto pb-24 lg:pb-0">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div>
          ...
          <h1 className="font-display-lg-mobile md:font-display-lg text-primary leading-tight">
            Halo, Zhofran 🌷
          </h1>
        ...
        <div className="flex gap-3">
          <button className="p-3 glass-card rounded-full text-primary active:scale-90">
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-grid-gutter">
        <section className="md:col-span-6 lg:col-span-8 group">
          <GlassCard className="h-full p-8 flex flex-col justify-between relative overflow-hidden bg-gradient-to-br from-white/60 to-primary-container/20 border-primary/20">
            ...
            <div>
              ...
              <h2 className="font-headline-md text-on-surface mb-4">Butuh tempat bercerita?</h2>
            ...
            <div className="flex flex-wrap gap-4 items-center">
              ...
              <span className="font-caption text-on-surface-variant italic">✨ Privasimu adalah prioritas kami</span>
            </div>
          </GlassCard>
        </section>
        ...
        <section className="md:col-span-3 lg:col-span-4">
          <GlassCard className="h-full p-6 flex flex-col">
            <div className="flex justify-between items-center mb-6">
              <h3 className="font-headline-sm text-on-surface">Status Laporan</h3>
              <span className="material-symbols-outlined text-primary">analytics</span>
            </div>
            <div className="flex-grow flex flex-col gap-4">
              <div className="p-4 rounded-xl bg-surface-container-low border border-white/40">
                <div className="flex justify-between mb-2">
                  <span className="font-label-md">Laporan #429</span>
                  <span className="px-2 py-0.5 rounded-full bg-secondary-container text-secondary text-xs font-bold">DIPROSES</span>
                </div>
                <div className="w-full h-2 bg-white rounded-full overflow-hidden">
                  <div className="h-full bg-gradient-to-r from-primary to-secondary w-2/3"></div>
                </div>
                <p className="font-caption text-on-surface-variant mt-2">Sedang ditinjau oleh Konselor</p>
              </div>
              <div className="p-4 rounded-xl bg-white/20 border border-white/10 flex items-center justify-center border-dashed">
                <span className="font-caption text-on-surface-variant">Belum ada laporan aktif lainnya</span>
              </div>
            </div>
        ...
        <section className="md:col-span-3 lg:col-span-4">
          <GlassCard className="h-full p-6 flex flex-col relative overflow-hidden">
            ...
            <h3 className="font-headline-sm text-on-surface mb-2">Safe Library</h3>
            <p className="font-caption text-on-surface-variant mb-6">Edukasi dan dukungan mental di genggamanmu.</p>
            <div className="space-y-4">
              <div className="flex gap-3 group cursor-pointer">
                ...
                <div className="flex flex-col">
                  <span className="font-label-md group-hover:text-primary transition-colors">Self-Care 101</span>
              ...
              <div className="flex gap-3 group cursor-pointer">
                ...
                <div className="flex flex-col">
                  <span className="font-label-md group-hover:text-primary transition-colors">Batas Sehat</span>
                  <span className="font-caption text-on-surface-variant">8 min read • 🛡️ Safe</span>
                </div>
              </div>
            </div>
            <button className="mt-auto pt-6 w-full py-3 border border-primary/20 rounded-xl text-primary font-bold font-label-md hover:bg-primary/5 transition-colors">
              Buka Perpustakaan
            </button>
          </GlassCard>
        </section>
        ...
        <section className="md:col-span-6 lg:col-span-5">
          <GlassCard className="h-full p-6">
            <h3 className="font-headline-sm text-on-surface mb-6">Aktivitas Terbaru</h3>
            <div className="space-y-6">
              <div className="flex gap-4 relative">
                <div className="w-0.5 h-12 bg-outline-variant absolute left-5 top-10"></div>
              ...
              <div className="flex gap-4 relative">
                <div className="w-0.5 h-12 bg-outline-variant absolute left-5 top-10"></div>
                <div className="w-10 h-10 rounded-full bg-tertiary-container flex items-center justify-center text-tertiary flex-shrink-0">
        ...
        <section className="md:col-span-6 lg:col-span-3 flex flex-col gap-grid-gutter">
          <GlassCard className="p-6 flex-grow bg-white/30 border-white/40">
          ...
          <GlassCard className="p-6 flex-grow bg-primary/5 border-primary/10">
            <div className="flex items-center gap-3 mb-4">
      ...
      <footer className="w-full py-section-gap border-t border-outline-variant/30 flex flex-col md:flex-row justify-between items-center gap-grid-gutter mt-12 relative z-10">
        <div>
          <span className="font-headline-sm text-on-surface mb-2 block">LINUKS</span>
          <p className="font-caption text-on-surface-variant opacity-70">© 2024 LINUKS. Supporting your journey with care.</p>
        </div>
        <div className="flex flex-wrap justify-center gap-6">
          <a href="#" className="font-caption text-on-surface-variant hover:text-primary transition-colors">Privacy Policy</a>
          <a href="#" className="font-caption text-on-surface-variant hover:text-primary transition-colors">Safety Guidelines</a>
          <a href="#" className="font-caption text-on-surface-variant hover:text-primary transition-colors">Support Center</a>
          <a href="#" className="font-caption text-on-surface-variant hover:text-primary transition-colors">Terms of Service</a>
        </div>
      </footer>
    </div>
  );
